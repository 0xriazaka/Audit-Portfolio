...
|-------------|----------|----------|------------|
| MaxDex | Move | Movement | [report](https://hashlock.com/wp-content/uploads/2025/08/Max-Smart-Contract-Audit-Report-Final-Report-v4.pdf) |
...
| Loopscale | Rust | Solana | [report](https://github.com/LoopscaleLabs/audits/blob/main/BEAM%20Adevar%20Labs%20Report.pdf) |
...
## Independent Audits Portfolio

| Project Name | Language | Platform | Report Link |
|-------------|----------|----------|------------|
| Crystara | Move | Supra | [report](https://github.com/0xriazaka/LST-Collection-V11-Audit-Report) |
